...
case "$LAYER" in
  week)
    ...
    OUTDIR="${VAULT_ROOT}/auto-review/${YEAR}/Q${QUARTER}/${MONTH_NUM}-${MONTH_NAME}/CW-${WEEK_NUM}"
    OUTFILE="${OUTDIR}/weekly-${WEEK_YEAR}-W${WEEK_NUM}.md"
    ;;
  month)
    OUTDIR="${VAULT_ROOT}/auto-review/${YEAR}/Q${QUARTER}/${MONTH_NUM}-${MONTH_NAME}"
    OUTFILE="${OUTDIR}/monthly-${YEAR}-${MONTH_NUM}.md"
    ;;
  quarter)
    OUTDIR="${VAULT_ROOT}/auto-review/${YEAR}/Q${QUARTER}"
    OUTFILE="${OUTDIR}/quarterly-${YEAR}-Q${QUARTER}.md"
    ;;
  year)
    OUTDIR="${VAULT_ROOT}/auto-review/${YEAR}"
